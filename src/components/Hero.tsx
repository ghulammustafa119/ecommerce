        ...
        <main className="bg-[#F2F0F1] mt-20 md:mt-24 lg:h-[615px] md:px-10 sm:pt-4  flex flex-col lg:flex-row justify-center lg:justify-between items-center lg:items-start max-w-screen-2xl mx-auto">
              {/* left */}
               <div className="  md:pl-0  lg:w-[600px] space-y-5  sm:pt-7 mt-10 px-3">
                ...
                <button
                  className="w-full sm:w-[140px] text-sm bg-black text-white py-2 px-8 rounded-[20px]"
                  onClick={() => router.push("/product")}
                >Shop Now</button>
                <div className="flex justify-evenly md:justify-between flex-wrap md:flex-nowrap gap-y-4 mt-4 ml-4 space-x-4 lg:hidden">
              ...
              width={200} height={200} alt="hero_image"></Image> 
               <Image src={"/images/star.png"}
               className="w-[70px] sm:w-[100px] absolute top-[60px] right-6 "
              width={200} height={200} alt="star-image"></Image> 
               <Image src={"/images/star.png"}
